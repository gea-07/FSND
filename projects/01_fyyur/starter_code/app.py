...
def create_show_submission():
  ...
  try:
    ...
    if artist and venue:
      ...
      error = True
      if not artist:
        flash('The artist id you entered is not in the database. Check the Artist\'s Page')
      if not venue:
        flash('The venue id you entered is not in the database. Check the Venue\'s Page')
  except:
    error = True
    db.session.rollback()
    print(sys.exc_info())
